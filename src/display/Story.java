...
public class Story {
	...
	private String[] story = new String[] { "In einer dystopischen Zukunft haben die Konzerne gewonnen.    ",
	...
	public Story() {
		...
		textarea = new Label();
		textarea.setStyle("	-fx-font-family: serif;" + "	-fx-font-weight: bold;" + "	-fx-font-size: 15px;"
		...
		scene.setOnKeyPressed(e -> {
			...
			if (new KeyCodeCombination(KeyCode.G, KeyCombination.CONTROL_DOWN).match(e))
				startGame();
			step();
		});
